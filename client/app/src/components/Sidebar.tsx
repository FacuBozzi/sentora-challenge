...
function SidebarItem({ icon, active = false, onClick }: SidebarItemProps) {
  return (
    <div
      className={`flex items-center justify-center p-3 cursor-pointer transition-colors ${active ? "text-blue-500 bg-light-button-blue rounded-lg" : "text-gray-500 hover:text-gray-700"}`}
      onClick={onClick}
    >
      {typeof icon === "string" ? (
...
export default function Sidebar() {
  return (
    <div className="h-screen w-16 flex flex-col items-center py-5 border-r bg-white">
